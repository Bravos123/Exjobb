...
import com.example.navigationtesting.RinexReader;
...
public class RetrieveSatelliteEphemerides {
    ...
    * */
    ...
    private OnRetrieveSatelliteEphemeridesCallback callback;

    public RetrieveSatelliteEphemerides(OnRetrieveSatelliteEphemeridesCallback callback){
        this.callback = (OnRetrieveSatelliteEphemeridesCallback) callback;
    }
